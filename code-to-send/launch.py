...
# Get as parameters:
#  - N: number of order
#  - city: one of Visano, Asola, Montichiari, Brescia, Roma (CASE SENSITIVE)
#  - timeout (in second)
#  - d: number of deliverers
#  - plot-map (flag): generate and save map figures with paths
...
# Load graph: needed for images generation 
