...
%
	...
	\begin{figure}
		...
		\end{subfigure}
			\begin{subfigure}[t]{1\textwidth}
				\centering
				\includegraphics[width=.5\textwidth]{graph_paths-min.png}
	...
	%\textit{we've not choosen the minimum path to reach the solution (ah-ah)!} 
	...
	%it can be a good idea to find a way to exclude orders 
	%whose destinations	are too far away to be made on the same travel.
